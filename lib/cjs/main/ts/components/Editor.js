...
exports.Editor = {
    ...
    mounted: function () {
        ...
        this.$nextTick(function () {
            _this.element = _this.$el;
            if (TinyMCE_1.getTinymce() !== null) {
                initialise(_this)();
            }
            else if (_this.element && _this.element.ownerDocument) {
                var channel = _this.$props.cloudChannel ? _this.$props.cloudChannel : '5';
                var apiKey = _this.$props.apiKey ? _this.$props.apiKey : 'no-api-key';
                var scriptSrc = Utils_1.isNullOrUndefined(_this.$props.tinymceScriptSrc) ?
                    "https://cdn.tiny.cloud/1/" + apiKey + "/tinymce/" + channel + "/tinymce.min.js" :
                    _this.$props.tinymceScriptSrc;
                ScriptLoader_1.ScriptLoader.load(_this.element.ownerDocument, scriptSrc, initialise(_this));
            }
        });
    },
